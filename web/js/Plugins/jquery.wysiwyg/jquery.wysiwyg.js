		...
		this.ui.initFrame = function () {
			...
			$(self.editorDoc).bind("click.wysiwyg", function (event) {
				self.ui.checkTargets(event.target ? event.target : event.srcElement);
                                //Fabian
                                /*
                                $(self.editorDoc.body).find("u").dblclick(function(event){
                                    $(event.currentTarget).html("<input id='temporal' style='z-index: 2147483647;'>");
                                    $( "#temporal" ).focus();
                                    $('#temporal').trigger({
                                        type: 'mousedown',
                                        which: 3
	...
	$(function () { // need access to jQuery UI stuff.
		...
		$.wysiwyg.dialog.register("default", function () {
			...
			this.init = function() {
				...
				var $link = $('<span style="cursor:pointer;" class="wysiwyg-dialog-close-button">X</span>');
