...
<html>
    <head>
        ...
        <script src="../js/radicacion_crp.js"></script>  
        <script type="text/javascript">
                        ...
                        <div class="right_col" role="main">
                            <div class="row">
                                <div class="page-title">                                    
                                    <h3>Radicación CRP </h3>
                                    <p>Herramienta para generar el archivo para la radicación de archivos CRP.</p>                                    
                                </div>
                                <br>
                                <div class="row">                                    
                                    <div class="col-lg-6 col-md-6 col-sm12 " id ="form_crp">                                       
                                        <div class="container">
                                            <div class="input-group">
                                                <label>CDP </label><input type="text" class="form-control" id="cdp" name="cdp"> 
                                            </div>                                                       
                                        </div>                                                       
                                        <div class="container">                                                       
                                            ...
                                            <div class="input-group">
                                                ...
                                                <br>
                                                <label> Número de resolución</label><input type="text" class="form-control" id="resolucion" name="resolucion"> 

                                            </div>                                                 

                                        </div>    
                                        <div>
                                            <button  class="btn btn-info" onclick="agregarCrp()">Agregar >></button>                                          
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm12"  >
                                        <table class="table text-centered" id="crp_radicados"> 
                                            <thead>
                                                <tr>
                                                    <th></th>                                                    
                                                    <th>Identificador</th>
                                        ...
                                        <div>
                                            <button  class="btn btn-warning disabled" id="btn_eliminar" onclick="eleminarSeleccion()">eliminar seleccionados</button>                                          
                                            <button  class="btn btn-success disabled" id="btn_gen" onclick="generarArchivo()">Generar Archivo </button>                                          
                                        </div>
                                    </div>
                                </div>
                            </div>
